...
import { faCalendarAlt, faDollarSign, faSmile, IconDefinition } from '@fortawesome/free-solid-svg-icons';
...
const AddIconButtonWrapper = styled.div<AddIconButtonContainerProps>`
  display: ${(props) => (props.shouldShow ? 'flex' : 'none')};
  margin-top: 1.25rem;
  margin-bottom: 1.25rem;
`;
...
export function GoalManager(props: Props) {
  ...
  const pickEmojiOnClick = (emoji: BaseEmoji, event: React.MouseEvent<any, MouseEvent>) => {
    event.stopPropagation();
  ...
  return (
    <GoalManagerContainer>
      ...
      <AddIconButtonWrapper shouldShow={hasIcon()}>
